		...
		<div class="epMcCtContent">
			...
			<div class="tab">
				<ul class="tabMenu none bordFont floatUl normalFont">
					<li class="first"><a href="<c:url value="/users/authorities-initial.htm"/>" class="current">菜单列表</a>
					</li>
					<li><a href="<c:url value="/users/authorities-input.htm?init=true"/>">新增菜单</a></li>
				</ul>
				<div class="">
