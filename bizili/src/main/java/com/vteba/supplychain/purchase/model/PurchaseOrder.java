 ...
 * 采购订单
 * @author yinlei 
 * date 2012-8-7 上午10:23:46
 */
@Entity
@Table(name = "purchase_order", catalog = "supplychain")
public class PurchaseOrder implements AstModel {

	private static final long serialVersionUID = 8249919918044659354L;
	...
	public PurchaseOrder(String orderId, String empNo, String empName,
