 ...
 * 采购单明细
 * @author yinlei 
 * date 2012-8-7 下午5:26:18
 */
@Entity
@Table(name = "purchase_form_detail", catalog = "supplychain")
public class PurchaseFormDetail implements AstModel {

	private static final long serialVersionUID = -1963162485390943813L;
	private String id;
	...
	public PurchaseFormDetail() {
	}

	public PurchaseFormDetail(String id) {
		this.id = id;
	}

	public PurchaseFormDetail(String id, String orderId, String stockId,
