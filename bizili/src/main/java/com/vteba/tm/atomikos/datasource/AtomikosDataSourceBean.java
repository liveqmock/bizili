 ...
 */
public class AtomikosDataSourceBean extends AbstractDataSourceBean implements ConnectionProvider{
	...
	protected com.atomikos.datasource.pool.ConnectionFactory doInit() throws Exception 
	{
		...
		if ( LOGGER.isInfoEnabled() ) LOGGER.logInfo(
			...
			com.atomikos.datasource.pool.ConnectionFactory cf = new AtomikosXAConnectionFactory(xaDataSource, tr, this);
	...
	public boolean isUnwrappableAs(@SuppressWarnings("rawtypes") Class unwrapType) {
		return MultiTenantConnectionProvider.class.equals(unwrapType)
				...
				|| XADataSource.class.isAssignableFrom(unwrapType);
	}
