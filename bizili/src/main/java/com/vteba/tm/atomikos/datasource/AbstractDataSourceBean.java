...
import com.atomikos.util.IntraVmObjectRegistry;
  ...
  */
public abstract class AbstractDataSourceBean implements HeuristicDataSource,
		ConnectionPoolProperties, Referenceable, Serializable {
	private static final long serialVersionUID = -494474670973379657L;
